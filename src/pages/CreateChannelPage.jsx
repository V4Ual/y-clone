...
const CreateChannelPage = () => {
  ...
  const { createChangeData, avatar, handleChangeInputChannel, errorMessage, handleOnSubmitChennal, isLoading } = useCreateChange()

  console.log(createChangeData)
  return (
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-8 space-y-6">
          ...
          <button
            ...
            onCanPlay={() => handleOnSubmitChennal()}
          >
